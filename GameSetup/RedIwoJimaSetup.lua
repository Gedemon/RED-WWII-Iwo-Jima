...
myModId = "afce9c94-fecc-485e-9f62-0c24b9848993";
myModVersion = Modding.GetActivatedModVersion(myModId);
scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "IwoJima.Civ5Map");
...
function SetPlayerIndex(playerIndex)
	...
	if(playerIndex ~= nil) then		
		...
		-- Sets Dawn of Man Quote
		Controls.Quote:LocalizeAndSetText("TEXT_KEY_RED_IWO_JIMA_BRIEFING");		
    end
